...
export const broadcastPolyfil = () => {
    (function (context) {
        ...
        function BroadcastChannel(channelName) {
            ...
            var _channelId = _prefix + channelName, isFirstChannel = _channels === null;
        ...
        BroadcastChannel.prototype.postMessage = function (data) {
            ...
            try {
                var editedJSON = JSON.stringify(editedObj), lsKey = "eomBCmessage_" + getRandomString() + "_" + this.channelId;
         ...
         */
        function _onmsg(ev) {
            var key = ev.key, newValue = ev.newValue, isRemoved = !newValue, obj = null;
